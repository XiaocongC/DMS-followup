...
class Interview
{
	// change the non static variable to static variable
...
// check the $_POST['person'] exist or not	
	...
	<table>
		...
		<tbody>
			<?php foreach ($people as $person): ?>
				<tr>
				<!-- change $person from object value to array value -->
